...
Ext.define('ZSMZJ.view.dbgl.ChangedBusinessGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.changedbusinesspanel',
    cls:'navigation-grid',
    requires: [
    ...
    initComponent: function() {
        Ext.apply(this, {
            border: false,
            stype:processstatustype.change,
            viewConfig: {
                trackOver: false,
                loadMask: true,
        ...
        ZSMZJ.view.dbgl.ChangedBusinessGrid.selectionModel = this.getSelectionModel();
