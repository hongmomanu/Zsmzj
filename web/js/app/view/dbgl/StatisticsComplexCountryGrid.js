...
Ext.define('ZSMZJ.view.dbgl.StatisticsComplexCountryGrid' ,{
    extend: 'Ext.tree.Panel',
    alias : 'widget.dbglstatisticscomplexcountrypanel',
    requires: [
    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            store: 'dbgl.StatisticsComplexCountrys'
