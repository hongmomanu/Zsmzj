    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            columns: [
                ...
                {header: '分类管理',align:'center',dataIndex:'poortype',itemId:'familytype',width: 70},

                {header: '家庭户口',align:'center',dataIndex:'familyaccount',itemId:'familyaccount',width: 70},
                {header: '救助金额',align:'center',dataIndex:'totalhelpmoney',summaryType: 'sum',width:100,//求数量
                    summaryRenderer: function(value){
                        return '总金额:'+value
                    }},
                {header: '救助开始日期',align:'center',dataIndex:'helpbgtime'},
                {header: '救助结束日期',align:'center',dataIndex:'helpedtime'},
                {header: '家庭人数',align:'center',dataIndex:'familynum',summaryType: 'sum', width:70,//求数量
                    summaryRenderer: function(value){
                        return '总人数:'+value
                    }},
                {header: '享受人数',align:'center',dataIndex:'enjoyednum',summaryType: 'sum', width:70,//求数量
                    summaryRenderer: function(value){
                        return '总人数:'+value
                    }},
